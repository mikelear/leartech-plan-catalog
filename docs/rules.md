...
**Fix:** Remove the GitOps step from the Plan. Compose the change via an OWNERS-gated infra PlanTemplate (use:), or have an operator apply it manually. A plain catalog Plan should not hand-author edits to jx-build-cluster-* repos.
